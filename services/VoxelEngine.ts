...
export class VoxelEngine {
  ...
  constructor(
    ...
    // Grid Helper
    // Size 200, divisions 200 (1 unit cells)
    this.gridHelper = new THREE.GridHelper(200, 200, 0x94a3b8, 0xcbd5e1);
    this.gridHelper.position.y = CONFIG.FLOOR_Y + 0.02; // Slightly above floor to avoid z-fighting
